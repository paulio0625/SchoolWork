/**
*This class holds the information for OtherStudent objects which are a subclass of the Student class.
...
public class OtherStudent extends Student{
	...
	**/
	public OtherStudent(String name, String ID, int yearOfStudy, int daysSinceRegistration){
	...
	**/
	public int priority(){
		return ((yearOfStudy() * 2)+(daysSinceRegistration()));
	}
}
