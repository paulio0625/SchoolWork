...
public class IntListTest {
 ...
 public static void dispatch(int choice) {
   ...
   switch (choice) {
	...
	case 6: //print
     ...
     break;
    case 7: //print
	 System.out.println("Enter the old integer you want to replace");
	 oldVal = scan.nextInt();
 ...
 public static void printMenu() {
  ...
  System.out.println("6: Remove the last integer of the list");
  System.out.println("7: Replaces all occurrences of old value in the list with new value.");
  System.out.print("\nEnter your choice: ");
 }
}
